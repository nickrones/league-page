/*   STEP 1   */
export const leagueID = "987158814866657280"; // your league ID
...
export const managers = [
    // {
      ...
      "rival": null {
        name: null "Rival", // Can be anything (usually your rival's name)
        link: null 6, // manager array number within this array, or null to link back to all managers page
      ...
      "favoritePlayer": null, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
       ...
       "philosophy": "Kicker's are starters too, faab for life", // (optional)
